# Retrospective: declarative-cognee-endpoint

> STUB: written after verify passed. Complete this post-implementation.
...
> Up-front quantified data — later Wins / Misses bullets reference it directly.
...
- **Test coverage signal**: <e.g. nix eval/build pass, or "n/a">
...
> Each `no` above must answer: what was skipped, why this cycle, how to prevent recurrence.

- <fill in post-implementation, or leave empty if all yes>
...
- [ ] [high/med/low] **<short rule>** → **Promote to** <memory / CLAUDE.md / schema / skill / one-off>
  > **Why**: <reason>
