...
stdenv.mkDerivation (finalAttrs: {
  ...
  # To restore nixpkgs cache parity, set doInstallCheck = true.
  # This also enables BUILD_UNITTESTS in cmakeFlags (line above),
  # compiling and running the full duckdb unit test suite.
