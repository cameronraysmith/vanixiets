...
- [Handling broken packages](/guides/handling-broken-packages/) - Fix broken packages from nixpkgs unstable with surgical hotfixes
- [MCP servers usage](/guides/mcp-servers-usage/) - Configure and use Model Context Protocol servers
