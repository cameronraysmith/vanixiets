...
Darwin machines use sops-nix for user-level secrets.
Clan vars darwin support is planned but not yet implemented; currently clan vars only operates on NixOS machines.
