...
|--------|----------------|-------|
| Clan vars | Supported | Active for system secrets |
...
The current implementation uses clan vars primarily for NixOS system secrets, with user secrets managed via sops-nix.
