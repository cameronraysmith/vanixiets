---
title: vanixiets
description: Multi-machine nix infrastructure using dendritic flake-parts and clan
template: splash
hero:
  tagline: "Multi-machine nix infrastructure for nixos, nix-darwin, and home-manager using dendritic flake-parts module architecture and clan fleet coordination."
  image:
...
<CardGrid stagger>
  <Card title="Dendritic module organization" icon="puzzle">
    Every nix file is a flake-parts module organized by feature category rather than by host.
  ...
  <Card title="Composable package overlays" icon="puzzle">
    Multi-layer overlay composition: simultaneously use multiple upstream nixpkgs channels, apply hotfixes, and define custom packages and overrides.
...
4. **simultaneously use multi multiple nixpkgs channels** - Per-package nixpkgs channel selection for resilience
...
<CardGrid>
  <Card title="Understand the architecture" icon="open-book">
    Dendritic flake-parts + clan architecture for multi-machine deployments.
    [Architecture overview →](/concepts/architecture-overview/)
  </Card>
  <Card title="See the dendritic flake-parts pattern in action" icon="puzzle">
    Feature-based flake-parts module organization.
    [Dendritic flake-parts architecture →](/concepts/dendritic-architecture/)
  </Card>
