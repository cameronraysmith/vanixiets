...
template: splash
hero:
  tagline: "Multi-machine Nix infrastructure for NixOS, nix-darwin, and home-manager using dendritic flake-parts module organization and clan deployment coordination."
  image:
