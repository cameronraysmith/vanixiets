...
<CardGrid stagger>
  ...
  <Card title="Declarative secrets management" icon="lock">
    Clan vars manages encrypted secrets (SSH keys, zerotier identities, API tokens).
    Uses sops encryption internally with automatic generation and deployment.
  </Card>
...
The documentation is organized into complementary sections:
