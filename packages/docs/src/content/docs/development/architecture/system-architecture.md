...
description: Key architectural decisions and rationale for infra
---
...
See [Testing](/about/contributing/testing/) for comprehensive documentation.
...
- Package name is `@infra/docs` not `@infra/starlight`
