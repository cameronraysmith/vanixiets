...
export const inputs = {
  ...
  start_at_slice: Type.Integer({ default: 0, minimum: 0, maximum: 12 }),
...
export const Slice = Type.Object({
  id: Type.Integer({ minimum: 0, maximum: 11 }), title: Type.String(), allowedPaths: Type.Array(Type.String(), { minItems: 1 }),
