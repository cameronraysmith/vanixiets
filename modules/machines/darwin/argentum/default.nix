  ...
  flake.modules.darwin."machines/darwin/argentum" =
    ...
    }:
    {
      ...
      users.users.christophersmith = {
        ...
        openssh.authorizedKeys.keys = inputs.self.lib.userIdentities.christophersmith.sshKeys;
      };
      ...
      home-manager = {
        ...
        # christophersmith (primary user): aggregates from typed user record
        users.christophersmith.imports = flakeUsers.christophersmith.aggregates ++ [
