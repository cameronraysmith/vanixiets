      ...
      in
      {
        ...
        programs.tmux = {
          ...
          extraConfig = ''
            ...
            bind-key "I" display-popup -E -w 80% -h 80% "fd --type f --hidden --follow --exclude .git --absolute-path | fzf --preview 'bat --color=always --style=numbers --line-range=:500 {}' | cb copy"
