...
description: Create isolated git worktrees for parallel development with automatic environment setup. Use when needing to work on multiple branches simultaneously.
