...
description: Data modeling conventions including database schemas, normalization, and ER diagrams. Load when designing database structures or data relationships.
---
