...
description: Nix development conventions including flake patterns, module structure, derivation best practices, and nix-darwin/home-manager patterns. Load when working with .nix files or nix-related configuration.
---
