...
- `preferences-compositional-continuous-verification` for the engineering counterpart that grounds its four-property hierarchy in Peircean pragmatism — the regulator-target relationship is an abductive inference made operationally checkable, and existence/traceability/adequacy/integrity lift evidential standards from individual claims to a regulator suite
